...
app_operations_url_local=$(cat /mnt/secrets-store/app-operations-url)
api_operations_url_local=$(cat /mnt/secrets-store/api-operations-url)
...
sed -i "s#\"app-operations-url\": \"\"#\"app-operations-url\": \"$app_operations_url_local\"#" /app/public-flutter/assets/assets/AppConfig.json
