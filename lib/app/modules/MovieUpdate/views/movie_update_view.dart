...
class MovieUpdateView extends StatelessWidget {
  MovieUpdateView({Key? key}) : super(key: key);

  MovieUpdateController controller =
      Get.put<MovieUpdateController>(MovieUpdateController());
        ...
        child: Column(
          ...
          children: [
            Expanded(
              child: Column(
                children: [
                  GetBuilder<MovieUpdateController>(
                    init: controller,
                    id: "updateView",
                    builder: (control) {
                      return Padding(
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: GetBuilder<MovieUpdateController>(
                            id: "grid",
                            builder: (controller) {
