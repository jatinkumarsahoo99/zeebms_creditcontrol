...
import 'package:bms_creditcontrol/app/providers/extensions/datagrid.dart';
import 'package:bms_creditcontrol/widgets/PlutoGridExport/lib/src/pdf/pluto_grid_pdf_export.dart';
...
class DataGridMenu {
  ...
  showGridCustomMenu(PlutoGridStateManager stateManager, TapDownDetails details,
    ...
    var selected = await showMenu(
        ...
        items: [
          ...
          const PopupMenuItem<DataGridMenuItem>(
            value: DataGridMenuItem.clearembargo,
            height: 36,
            enabled: true,
            child: Text('Clear Embargo', style: TextStyle(fontSize: 13)),
          ),
        ]);
    if (onPressedClick != null) {
      print("Selected index is>>>" + plutoContext.rowIdx.toString());
  ...
  showGridCustomMenu1(PlutoGridStateManager stateManager, TapDownDetails details,
      BuildContext context,
      {String? exportFileName,
        Function? onPressedClick,
        required dynamic data,
