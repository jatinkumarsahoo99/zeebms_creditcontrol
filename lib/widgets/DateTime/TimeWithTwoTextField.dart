...
class TimeWithTwoTextField extends StatefulWidget {
  ...
  @override
  State<TimeWithTwoTextField> createState() =>
      _DateTimeWithThreeTextFieldState();
}

class _DateTimeWithThreeTextFieldState extends State<TimeWithTwoTextField> {
