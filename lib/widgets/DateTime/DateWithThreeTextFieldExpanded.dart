...
class DateWithThreeTextFieldExpanded extends StatefulWidget {
  ...
  const DateWithThreeTextFieldExpanded(
      {Key? key,
      required this.title,
  ...
  @override
  State<DateWithThreeTextFieldExpanded> createState() =>
      _DateWithThreeTextFieldState();
}

class _DateWithThreeTextFieldState
    extends State<DateWithThreeTextFieldExpanded> {
          ...
          Row(
            ...
            children: [
              if (widget.titleInLeft) ...{
                ...
                ///
                SizedBox(
                  width: widget.titleInSizeBox != null
                      ? widget.titleInSizeBox
                      : null,
                  child: Text(
                    widget.title,
                    style: TextStyle(
                                ...
                                showDatePicker(
                                  ...
                                  (selectedDate) {
                                    ...
                                    if (selectedDate != null) {
                                      ...
                                      textCtr[1].text = getMonthsFromIndex(
                                          selectedDate.month);
                                      textCtr[2].text =
